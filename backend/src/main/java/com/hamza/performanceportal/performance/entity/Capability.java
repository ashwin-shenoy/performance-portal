...
/**
 * Capability entity representing performance portal capabilities
 */
@Entity
...
public class Capability {
    ...
    @Builder.Default
    @Column(name = "instana_config", columnDefinition = "TEXT")
    @Convert(converter = JsonbConverter.class)
    private Map<String, Object> instanaConfig = new HashMap<>();
