...
public interface TestRunRepository extends JpaRepository<TestRun, Long> {
    ...
    /**
     * Find all test runs in a batch
     */
    List<TestRun> findByTestBatch(TestBatch testBatch);

    /**
     * Find test runs by batch ID
     */
    @Query("SELECT tr FROM TestRun tr WHERE tr.testBatch.batchId = :batchId")
    List<TestRun> findByTestBatchId(@Param("batchId") String batchId);
}
